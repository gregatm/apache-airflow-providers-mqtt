...
from airflow.providers.mqtt.triggers.await_message import AwaitMessageTrigger
from airflow.providers.common.messaging.providers.base_provider import BaseMessageQueueProvider

class MqttMessageQueueProvider(BaseMessageQueueProvider):
    scheme = "mqtt"

    def queue_matches(self, queue: str) -> bool:
        return queue.startswith(self.scheme)
